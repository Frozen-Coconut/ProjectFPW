...
Route::prefix('/')->middleware('loginregister')->group(function () {
...
Route::prefix('project')->middleware(['user', 'project'])->group(function () {
...
Route::prefix('file')->middleware(['user', 'file'])->group(function () {
