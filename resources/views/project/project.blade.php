        ...
        <div class="inline-flex relative w-fit" style="height: 40px;">
            ...
            <div class="px-1 py-1 bg-blue-500 flex items-center justify-center text-center rounded-lg shadow-lg">
              <div class="flex justify-center items-center" style="width: 30px;height:30px">
                <svg style="width: 25px;height:25px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bell" class="mx-auto text-white w-10" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
